...
from voice_of_patient.main import record_audio, transcribe_with_groq
from voice_of_doctor.main import text_to_speech_with_gtts, text_to_speech_with_elevenlabs
...
iface = gr.Interface(
    ...
    outputs=[
        ...
        gr.Audio("Temp.mp3",interactive=False)
    ],
