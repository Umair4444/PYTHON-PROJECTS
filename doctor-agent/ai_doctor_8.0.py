...
def launch_gradio():
    with gr.Blocks(title="AI Doctor with Vision and Voice + Urdu") as demo:
        ...
        welcome_audio = gr.Audio(value=WELCOME_AUDIO_PATH, label="🔊 Welcome Voice", interactive=False)
        ...
        replay_btn_english.click(fn=replay_audio, inputs=[audio_output_english], outputs=[audio_output_english])
        replay_btn_urdu.click(fn=replay_audio, inputs=[audio_output_urdu], outputs=[audio_output_urdu])
...
# start with asking "I am An A.I doctor. Please ask your question and upload an image so I can help you?"
