...
# Directory to save audio responses of doctor and patient and text resposne of patient and doctor and translation in output directory
...
def process_inputs(audio_filepath, image_filepath, patient_text=None, translate=False):
    ...
    text_to_speech_with_elevenlabs(input_text=doctor_response, output_filepath=audio_output_path) # for english
    # text_to_speech_with_elevenlabs(input_text=urdu_response, output_filepath=audio_output_path) # for urdu response
